...
about: Want us to add any features to SchoolOCR?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with SchoolOCR. Please take the time to
...
<!--
  Why do you want to see this feature in SchoolOCR? What use cases does it support?
-->
